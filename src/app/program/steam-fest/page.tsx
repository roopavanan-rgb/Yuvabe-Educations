...
const images = [
  { src: '/images/steam/image2.png', width: 415, height: 299, x: 480, y: 350 },
  { src: '/images/steam/image1.png', width: 315, height: 315, x: 900, y: 150 },
  { src: '/images/steam/image4.png', width: 200, height: 200, x: 250, y: 350 }, 
  { src: '/images/steam/image6.png', width: 200, height: 200, x: 680, y: 140 },
  { src: '/images/steam/image5.png', width: 232, height: 232, x: 0, y: 250 },
  { src: '/images/steam/image3.png', width: 415, height: 299, x: 250, y: 40 },
];
    ...
    <>
      <section className="py-12 px-6 md:px-16 lg:px-24 text-center">
        ...
        >
          ...
          STEAM Fest is a dynamic celebration of innovation, creativity, and learning, where students showcase their exciting projects and explore new ideas in science, technology, engineering, arts, and math. With interactive exhibits, hands-on activities, and inspiring demonstrations, it’s an event that brings together the community to celebrate the power of curiosity and creativity. Join us for a day filled with discovery, fun, and endless possibilities!          </p>
        </motion.div>
