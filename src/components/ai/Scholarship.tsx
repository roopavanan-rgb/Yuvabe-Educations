    ...
    <section className="bg-[#0C2F47] py-16 px-4 text-white text-center">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="p-8 md:p-10 bg-transparent border border-[#58AEE9] rounded-3xl">
          {/* <div className="absolute -right-60 bottom-200 border-none  border rounded-full bg-gradient-to-r bg-[#3991BD] opacity-40"></div> */}
        ...
        <div>
          <div className="absolute text-5xl -left-60 bottom-200  blur-3xl border-none w-96 h-96 border rounded-full bg-gradient-to-r bg-[#3991BD] opacity-10"></div>
          ...
          <Button
            size="lg"
            className="bg-white text-black mt-12 hover:bg-[#58AEE9]"
