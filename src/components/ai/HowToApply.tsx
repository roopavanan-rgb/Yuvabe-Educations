  ...
  return (
    <section className="bg-[#0C2F47] py-16 px-4 text-white text-center">
      <div className="max-w-3xl mx-auto space-y-12">
        <h2 className="text-2xl md:text-3xl font-raleway font-bold">
          How to Apply
        </h2>
        ...
        <div className="flex flex-col md:flex-row items-center text-left space-y-4 md:space-y-0 md:space-x-6">
          ...
          <div>
            <h3 className="text-2xl font-bold text-[#7CB518]">Get Started</h3>
            <p className="text-lg md:text-base">
              Once selected, you’ll receive materials and guidance to begin your
              AI/ML <br />
              journey with us.
            </p>
          </div>
      ...
      <div className=" mt-16 p-8 border border-[#58AEE9] rounded-3xl text-center max-w-4xl mx-auto">
        ...
        <p className="mt-4 text-base max-w-2xl mx-auto">
          Gain the skills, network, and experience you need to stand out in the
          competitive AI and ML fields. Apply now and be part of a program that
          transforms careers.
        </p>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-center gap-8">
          ...
          <Button
            size="lg"
            variant="outline"
            className="gap-2 border-white bg-[#0C2A41] hover:bg-blue-950 cursor-pointer"
      ...
      <div className=" mt-16 text-center">
        ...
        <p className="mt-4">
          For any questions, use the form below or reach out to our team
          directly at <strong>info@yuvabe.com</strong>
        </p>

        {/* Follow Us on Social Media */}
        <h3 className="mt-16 text-lg font-bold font-sans">
          Follow us on Social Media
        </h3>
        ...
        <div className="mt-6 flex justify-center space-x-6">
          ...
          <img
            ...
            alt="LinkedIn"
            className="w-10 h-10 rounded-square"
          />
        </div>
        ...
        <div className="mt-16 flex justify-center space-x-8">
          <img
            src="/icons/yuvabelogo.svg"
            alt="Yuvabe Logo"
            className="w-32 h-12 rounded-lg"
          />
          <img
            src="/icons/steamlogo.svg"
            alt="Steam Logo"
            className="w-38 h-12 rounded-lg"
          />
        </div>
      </div>
