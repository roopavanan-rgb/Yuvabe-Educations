      ...
      <section className="relative bg-[#002357] py-20 px-4 sm:px-6 md:px-12 text-white text-center overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <p className="mt-3 text-sm sm:text-base md:text-lg text-white/80 max-w-2xl mx-auto">
            Last Date to Apply:{" "}
            <span className="text-[#FFC107] font-bold">07 October 2026</span>
          </p>
          ...
          <div className="mt-8 flex justify-center">
            <Button
              size="lg"
              className="w-full sm:w-auto bg-[#FFC107] text-black font-semibold px-8 py-6 rounded-2xl cursor-pointer"
              onClick={() =>
                window.open(
