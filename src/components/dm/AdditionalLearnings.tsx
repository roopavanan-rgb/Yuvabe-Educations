...
//       <div className="absolute left-10 blur-3xl w-90 h-90 rounded-full bg-[#976346] opacity-10"></div>
//       {/* Title */}
//       <h2 className="text-3xl font-raleway font-semibold text-center text-[#FFCA2D] mb-4">
//         Additional Learnings
//       </h2>
//       <div className="h-[3px] w-275 bg-[#FFCA2D] mx-auto mb-6"></div>

//       {/* Subheading */}
//       <p className="text-center text-[#FFFFFF] text-3xl font-sans font-semibold w-full mx-auto mb-12">
...
export function AdditionalLearnings() {
  return (
    <section className="relative w-full py-12 bg-[#140F20] text-white overflow-x-hidden">
      <div className="absolute left-10 blur-3xl w-72 h-72 rounded-full bg-[#976346] opacity-10" />

      {/* Title */}
      <h2 className="text-3xl font-raleway font-semibold text-center text-[#FFCA2D] mb-4">
        Additional Learnings
      </h2>
      <div className="h-[3px] w-60 bg-[#FFCA2D] mx-auto mb-6" />

      {/* Subheading */}
      <p className="text-center text-white text-lg md:text-2xl font-sans font-semibold px-4 max-w-4xl mx-auto mb-12 leading-relaxed">
        Alongside your primary subject, the program offers comprehensive support
        training to equip you with essential career-related skills, including:
      </p>

      {/* Two-Column Layout */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 sm:px-10 max-w-6xl mx-auto">
        {learnings.map((item, index) => (
          <motion.div
            key={index}
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            {/* Bullet Point */}
            <span className="text-[#FFCA2D] text-xl mt-1">●</span>
